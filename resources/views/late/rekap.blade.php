                    ...
                    <tbody>
                        @foreach ($students as $item)
                            <tr>
                                ...
                                <td>{{ $item->nis }}</td>
                                <td>{{ $item->name }}</td>
                                <td>{{ $item->lates->count() }}</td>
                                <td>
                                    <div class="flex gap-2">
                                        <a href="{{ route('late.show', $item->id) }}"
                                            class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700">lihat</a>
                                        @if ($item->lates->count() >= 3)
                                            <a href="{{ route('late.print-pdf', $item->id) }}"
                                                class="px-4 py-2 text-white bg-yellow-400 rounded hover:bg-yellow-500">Cetak
                                                Surat Pernyataan</a>
                                        @endif
                                    </div>
                                </td>
